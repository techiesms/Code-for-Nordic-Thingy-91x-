...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_MODE_CONTINUOUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_ASSISTANCE_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_POWER_SAVING_DISABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_REFERENCE_LATITUDE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_REFERENCE_LONGITUDE, 1);
