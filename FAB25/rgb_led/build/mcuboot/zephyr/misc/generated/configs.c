...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_SERIAL_IMG_GRP_IMAGE_STATE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_ATLEAST_REQUIRED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_ATLEAST_REQUIRED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FW_INFO_FIRMWARE_VERSION, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_THINGY91X_NRF9151, 1);
